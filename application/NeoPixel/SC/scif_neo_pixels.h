/** \mainpage Driver Overview
  ...
  * - <b>Project file</b>:     C:/Users/hzaib/workspace_v12/spicontroller_LP_EM_CC1314R10_tirtos7_ticlang/NeoPixel/source_sc/NeoPixel/NeoPixelsDriver.scp
  * - <b>Code prefix</b>:      NEO PIXELS
  * - <b>Operating system</b>: TI-RTOS
  * - <b>Tool version</b>:     2.9.0.208
  * - <b>Tool patches</b>:     None
  * - <b>Target chip</b>:      CC1354R10, package QFN48 7x7 RGZ, revision A (1.0)
  * - <b>Created</b>:          2024-07-17 18:35:16.798
  * - <b>Computer</b>:         HASEEB
  * - <b>User</b>:             hzaib
  *
  ...
  * - NeoPixelsTask:
  *     - <b>O: Pin connected to the control signal</b>: DIO12
  *
  *
...
/// Target chip name
#define SCIF_NEO_PIXELS_TARGET_CHIP_NAME_CC1354R10
/// Target chip package
...
#define SCIF_NEO_PIXELS_NEO_PIXELS_TASK_TABLE_STATE_LENGTH 150
/// NeoPixelsTask I/O mapping: Pin connected to the control signal
#define SCIF_NEO_PIXELS_NEO_PIXELS_TASK_DIO_O_NEO_PIXELS_PIN 12
...
typedef struct {
    uint16_t NeoPixelsTableState[150]; ///< Table holding the NeoPixels state 
