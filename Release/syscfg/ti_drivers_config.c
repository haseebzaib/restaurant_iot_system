...
GPIO_PinConfig gpioPinConfigs[48] = {
    ...
    /* Owned by BTN_WATER as Button GPIO */
    GPIO_CFG_INPUT_INTERNAL | GPIO_CFG_IN_INT_NONE | GPIO_CFG_PULL_NONE_INTERNAL, /* CONFIG_GPIO_BTN_WATER_INPUT */
    /* Owned by BTN_CALL as Button GPIO */
    GPIO_CFG_INPUT_INTERNAL | GPIO_CFG_IN_INT_NONE | GPIO_CFG_PULL_NONE_INTERNAL, /* CONFIG_GPIO_BTN_CALL_INPUT */
    /* Owned by BTN_ORDER as Button GPIO */
    GPIO_CFG_INPUT_INTERNAL | GPIO_CFG_IN_INT_NONE | GPIO_CFG_PULL_NONE_INTERNAL, /* CONFIG_GPIO_BTN_ORDER_INPUT */
    /* Owned by BTN_BILL as Button GPIO */
    GPIO_CFG_INPUT_INTERNAL | GPIO_CFG_IN_INT_NONE | GPIO_CFG_PULL_NONE_INTERNAL, /* CONFIG_GPIO_BTN_BILL_INPUT */
...
const uint_least8_t CONFIG_GPIO_BTN_CALL_INPUT_CONST = CONFIG_GPIO_BTN_CALL_INPUT;
const uint_least8_t CONFIG_GPIO_BTN_WATER_INPUT_CONST = CONFIG_GPIO_BTN_WATER_INPUT;
const uint_least8_t CONFIG_GPIO_BTN_ORDER_INPUT_CONST = CONFIG_GPIO_BTN_ORDER_INPUT;
const uint_least8_t CONFIG_GPIO_BTN_BILL_INPUT_CONST = CONFIG_GPIO_BTN_BILL_INPUT;
...
static const Button_HWAttrs ButtonHWAttrs[CONFIG_BUTTON_COUNT] = {
    ...
    {
        .gpioIndex = CONFIG_GPIO_BTN_CALL_INPUT,
    ...
    {
        .gpioIndex = CONFIG_GPIO_BTN_WATER_INPUT,
        .pullMode = Button_PULL_UP,
        .internalPullEnabled = 1,
    },
    /* BTN_ORDER */
    {
        .gpioIndex = CONFIG_GPIO_BTN_ORDER_INPUT,
        .pullMode = Button_PULL_UP,
        .internalPullEnabled = 1,
    },
    /* BTN_BILL */
    {
        .gpioIndex = CONFIG_GPIO_BTN_BILL_INPUT,
        .pullMode = Button_PULL_UP,
        .internalPullEnabled = 1,
    },
};
...
const Button_Config Button_config[CONFIG_BUTTON_COUNT] = {
    ...
    /* LaunchPad Button BTN-1 (Left) */
    {
        .object = &ButtonObjects[BTN_CALL],
        .hwAttrs = &ButtonHWAttrs[BTN_CALL]
    },
    /* BTN_WATER */
    /* LaunchPad Button BTN-2 (Right) */
    {
        .object = &ButtonObjects[BTN_WATER],
        .hwAttrs = &ButtonHWAttrs[BTN_WATER]
    },
    /* BTN_ORDER */
    {
        .object = &ButtonObjects[BTN_ORDER],
        .hwAttrs = &ButtonHWAttrs[BTN_ORDER]
    },
    /* BTN_BILL */
    {
        .object = &ButtonObjects[BTN_BILL],
        .hwAttrs = &ButtonHWAttrs[BTN_BILL]
    },
};

const uint_least8_t BTN_CALL_CONST = BTN_CALL;
const uint_least8_t BTN_WATER_CONST = BTN_WATER;
const uint_least8_t BTN_ORDER_CONST = BTN_ORDER;
const uint_least8_t BTN_BILL_CONST = BTN_BILL;
